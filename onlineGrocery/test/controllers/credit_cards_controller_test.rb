...
class CreditCardsControllerTest < ActionController::TestCase
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post :create, credit_card: { card_numbers: @credit_card.card_numbers, cvs: @credit_card.cvs, expire: @credit_card.expire, user_id: @credit_card.user_id }
    end
  ...
  test "should update credit_card" do
    patch :update, id: @credit_card, credit_card: { card_numbers: @credit_card.card_numbers, cvs: @credit_card.cvs, expire: @credit_card.expire, user_id: @credit_card.user_id }
    assert_redirected_to credit_card_path(assigns(:credit_card))
  end
